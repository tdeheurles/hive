...
class Menu:
    ...
    def parse(self, commands):
        ...
        subparsers = {
            service_name: parsers[main_name].add_subparsers(title=service_name, dest="service")
        }

        for commandName in commands:
            command = commands[commandName]
            parsers[commandName] = subparsers[service_name].add_parser(commandName, help=command["help"])
